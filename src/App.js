...
import slide_image_7 from './assets/images/7.jpg';
import slide_image_8 from './assets/images/8.jpg';
import slide_image_9 from './assets/images/9.jpg';

function App() {
  return (
    <div className="container">
      <h1 className="heading"> <br /> <br /> <br /> <br /> </h1>
      <Swiper
        effect={'coverflow'}
        grabCursor={true}
        centeredSlides={true}
